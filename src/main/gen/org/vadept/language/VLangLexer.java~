 ...
 * from the specification file <tt>VLang.flex</tt>
 */
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { yybegin(YYINITIAL); return VLangTypes.KEY;
            } 
            // fall through
          case 8: break;
          case 2: 
          ...
          case 11: break;
          case 5: 
            { yybegin(WAITING_VALUE); return VLangTypes.SEPARATOR;
            } 
            // fall through
          case 12: break;
          case 6: 
            { yybegin(YYINITIAL); return VLangTypes.VALUE;
            } 
            // fall through
          case 13: break;
          case 7: 
